        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <motion.div variants={itemVariants} className="lg:col-span-4 lg:sticky lg:top-8 space-y-6">
            ...
            <div className="px-2 space-y-4">
              <div>
                <h3 className="text-xl font-bold text-white">Md. Kamrul Islam Khan</h3>
                <p className="text-sm font-semibold text-orange-400">CEO & Founder</p>
                <p className="text-xs text-slate-500">Raima International Travel</p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="lg:col-span-8 space-y-8">
            ...
            <div className="space-y-6 text-base text-slate-300 leading-relaxed font-light">
              <h2 className="text-xl font-bold text-white">Dear Valued Travelers and Corporate Partners,</h2>
              
              <p>
                Welcome to <span className="font-semibold text-white">Raima International Travel</span>. Since our foundation in 2025, our objective has centered entirely around designing an infrastructure that addresses modern travel complexities with professional transparency and precision.
              </p>
              <p>
            ...
            <div className="pt-6 border-t border-slate-700/50 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
              <div className="space-y-1">
                ...
                <div className="text-slate-200 my-2 h-12 flex items-center">
                  <span className="font-serif text-3xl opacity-40 italic select-none">Md. Kamrul Islam Khan</span>
                </div>
                <h4 className="text-base font-bold text-white">Md. Kamrul Islam Khan</h4>
              ...
              <div className="flex gap-4 p-4 rounded-xl bg-slate-800/40 border border-slate-700 max-w-sm">
                ...
                <div>
                  <h5 className="text-sm font-bold text-white">Verified Certification Standard</h5>
                  <p className="text-xs text-slate-400 mt-0.5">Compliant with IATA routing rules and premium hospitality directives from Dhaka.</p>
                </div>
              </div>
            </div>
