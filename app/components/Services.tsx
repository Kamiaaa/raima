...
const services: Service[] = [
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-10 text-orange-400">
...
const ServicesSection: React.FC = () => {
  ...
  return (
    <div className="bg-slate-900 px-4 py-16 md:py-20 transition-colors duration-300 text-white">
      <div id="features" className="mx-auto max-w-6xl">
        ...
        {/* Services Grid */}
        <ul className="mt-12 grid grid-cols-1 gap-6 text-center text-slate-300 md:grid-cols-2 lg:grid-cols-3">
          {services.map((service, index) => (
            <li
              key={index}
              className="rounded-xl bg-slate-800 px-6 py-8 shadow-md transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
            >
              {service.href ? (
                <a href={service.href} className="group block">
                  ...
                  <h3 className="my-3 font-display text-xl font-semibold text-white transition-colors group-hover:text-orange-400">
                    {service.name}
                  </h3>
                ...
                <>
                  ...
                  <h3 className="my-3 font-display text-xl font-semibold text-white">
                    {service.name}
                  </h3>
                  <p className="mt-1.5 text-sm leading-6 text-slate-400">
                    {service.description}
